...
console.log(`
Вёрстка +10: 
- на странице есть несколько карточек фильмов и строка поиска. На каждой карточке фильма есть постер и название фильма. Также на карточке может есть другая информация, рейтинг фильма. +5
- в футере приложения есть ссылка на гитхаб автора приложения, год создания приложения, логотип курса со ссылкой на курс +5
При загрузке приложения на странице отображаются карточки фильмов с полученными от API данными +10.
Если в поле поиска ввести слово и отправить поисковый запрос, на странице отобразятся карточки фильмов +10.
Поиск +30:
...
- высокое качество оформления приложения: собственное оригинальное оформление.
- дополнительным функционалом, наличие на карточке фильма его описания, рейтинга, даты релиза.
Итого: 70 / 70 баллов.
`);
